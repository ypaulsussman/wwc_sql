...
(
  ...
  School_setting_Student_Count int,
...
(
  ...
  Outcome_Measure_Intervention_Sample_Size float,
  Outcome_Measure_Comparison_Sample_Size float,
  Intervention_Clusters_Sample_Size int,
  Comparison_Clusters_Sample_Size int,
  Intervention_Mean float,
  Comparison_Mean float,
  Intervention_Standard_Deviation float,
  Comparison_Standard_Deviation float,
  Effect_Size_Study float,
  Effect_Size_WWC float,
  Improvement_Index float,
  p_Value_Study float,
  p_Value_WWC float,
  ICC float,
  Clusters_Total float,
...
Protocol_Version numeric(5,2), 
Outcome_Domain text, 
NumStudiesMeetingStandards int, 
NumStudiesEligible int, 
Class_type_General boolean, 
Class_type_Inclusion boolean, 
Delivery_Method_Individual boolean, 
Delivery_Method_School boolean, 
